...
BUNDLED_PROMPT = SKILL_ROOT / "references" / "stock-analyzer-01.md"


class SkillPackagingTest(unittest.TestCase):
    def test_analysis_prompt_is_bundled_inside_skill(self) -> None:
    ...
    def test_repo_prompt_copy_stays_in_sync_when_available(self) -> None:
        ...
        self.assertEqual(repo_prompt.read_bytes(), BUNDLED_PROMPT.read_bytes())
